    ...
    <div className="flex-1 flex flex-col min-h-0 bg-neutral-50 dark:bg-black theme-transition">
      <header className="px-8 py-6 border-b border-neutral-200 dark:border-neutral-900 bg-white dark:bg-[#0a0a0a] flex items-center justify-between theme-transition sticky top-0 z-30">
        <div className="flex items-center space-x-4">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center border-2 border-amber-400/30 shadow-md shrink-0 bg-neutral-950">
             <span className="text-amber-400 font-black italic text-lg select-none">H</span>
          </div>
          <div>
        ...
        <div className="flex space-x-2">
          <button className="px-4 py-2 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg text-[10px] font-black uppercase tracking-widest text-neutral-600 dark:text-neutral-400 hover:border-amber-500/50 transition shadow-sm">
